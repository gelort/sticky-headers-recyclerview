...
public class MainActivity extends AppCompatActivity {
    private static int MINI_VIEW_TYPE = 1;
    private static int MAX_VIEW_TYPE = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LinearLayoutManager layoutManager =
                new LinearLayoutManager(this, orientation, isReverseButton.isChecked());
    ...
    private class AnimalsHeadersAdapter extends AnimalsAdapter<RecyclerView.ViewHolder>
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(viewType == MINI_VIEW_TYPE ? R.layout.view_item
                            : R.layout.view_big_item, parent, false);
